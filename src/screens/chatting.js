...
const ChatScreen = ({ navigation, route }) => {
  ...
  const getMessages = () => {
    ...
    AsyncStorage.getItem('user', (err, userData) => {
      ...
      if (userData) {
        ...
        console.log("sender_id: " + userDetails.customer_id + ' receiver_id: ' + route?.params?.receiver_id)
  ...
  const renderAttachment = (props) => {
    // return (<TouchableOpacity onPress={selectFile} style={{ padding: 20, backgroundColor: "#EAE9E6", flexDirection: 'row', justifyContent: 'space-around' }}>
    //   <Image source={require('../assets/presep.png')} style={{ height: 10, width: 10, padding: 2, resizeMode: 'contain' }} />
    // </TouchableOpacity>)

    return (<View style={{ flexDirection: 'row' }}>
      <TouchableOpacity onPress={() => navigation.goBack()} style={{ padding: 20, backgroundColor: "#EAE9E6", flexDirection: 'row', justifyContent: 'space-around' }}>
        <Image source={require('../assets/back.png')} style={{ height: 10, width: 10, padding: 2, resizeMode: 'contain' }} />
      </TouchableOpacity>
