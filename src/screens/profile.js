                            ...
                            <ImageBackground source={require('../assets/profile1.1.png')} resizeMode='cover' style={{ alignItems: "center", width: "100%", height: vh * 0.50, }}>
                                ...
                                <View style={{ marginRight: vw * 0.8, padding: 20 }} >
                                    <TouchableOpacity onPress={() => { props.navigation.navigate("myTab") }}
                                        ...
                                        <Image source={require('../assets/menu.png')} resizeMode='contain' style={{ height: 10, width: 20, }} />
                                    </TouchableOpacity>
                                </View>

                                <View style={{ height: vh * 0.25, width: vw * 0.50,  marginVertical: vh * 0.03, }}>

                                    <ImageBackground imageStyle={{  borderRadius: 100  }} source={profileimage}  style={{ height: 180, width: 180,  }} >
